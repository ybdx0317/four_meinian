...
public class QiniuUtils {
    ...
    public  static String accessKey = "_02f1DD5A2yDOZzHFhJ46nIYVq9rZ8edWNwpZEyC";
    public  static String secretKey = "SHjVDQe5CNGSaC_BEwzFKOwSC8ztvBZIci4ORh2l";
    public  static String bucket = "lamosi";
